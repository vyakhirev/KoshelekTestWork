...
Всё, что покажется в задании непонятным или неоднозначным к трактовке, делайте на
свое усмотрение, соблюдая здоровый рационализм.
Главное - это общий полученный результат. Если возникнет непреодолимое по
вашему мнению препятствие, пиши свой(и) вопрос(ы) нам.
Готовое задание прислать в ZIP архиве. К тестовому заданию приложить видео с
демонстрацией работы приложения.
